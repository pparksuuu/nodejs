var output = '안녕!';
var buffer1 = new Buffer(10); // 길이가 10인 버퍼 객체 만들기
...
console.log('byteLen : ' + byteLen); // 글자수에 상관 없이 버퍼 크기 출력

var str1 = buffer1.toString('utf8', 0, 6);
console.log('str1 : ' + str1);

var buffer2 = Buffer.from('Hello', 'utf8'); // 버퍼 객체를 만들어주세요
console.log('두번째 버퍼의 길이 : ' + Buffer.byteLength(buffer2));

// 버퍼는 한 번 만들어지면 길이값이 달라지기 어렵다. 고정 단위.
